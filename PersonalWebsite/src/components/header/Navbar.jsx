    ...
    return (
        <>
            <div className="p-5 grid grid-cols-3 justify-evenly gap-3">
                <button className="flex rounded-lg bg-emerald-600 ring-2 ring-emerald-400 hover:ring-offset-[3px] hover:ring-offset-base hover:bg-teal-500 hover:scale-[1.01]">
