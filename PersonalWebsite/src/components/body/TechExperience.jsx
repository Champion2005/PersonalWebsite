...
export const TechExperience = () => {
    ...
    return (
        <>
            <section className='flex flex-col select-none mt-20 py-10 relative after:absolute after:bg-blue after:inset-0 after:skew-y-3 after:-z-10 after:bg-gradient-to-br after:from-emerald-800 after:to-emerald-500 after:border-y-4 after:border-white/50'>
                <h2 className="pt-5 text-center text-black/75 text-4xl font-bold">Experienced with:</h2>

                <div className='py-10 self-center w-[75%] fade'>
                    <Slider width="7rem">
                        <Slider.Slide>
